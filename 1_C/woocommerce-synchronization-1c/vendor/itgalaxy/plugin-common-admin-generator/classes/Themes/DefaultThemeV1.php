...
class DefaultThemeV1
{
                ...
                'childes' => [
                    [
                        ...
                        'input_attributes' => [
                            ...
                            'data-nonce' => isset($args['enableNonce']) ? $args['enableNonce'] : '',
                            'data-nonce-name' => isset($args['enableNonceName']) ? $args['enableNonceName'] : '',
                    ...
                    [
                        ...
                        'attributes' => [
                            ...
                            'data-nonce' => isset($args['clearNonce']) ? $args['clearNonce'] : '',
                            'data-nonce-name' => isset($args['clearNonceName']) ? $args['clearNonceName'] : '',
                            'href' => '#',
                        ],
                    ],
                    [
     ...
     * @return void
     */
    public static function licenseBlock($code, $action, $nonce, $nonceName)
    {
        if ($code) {
        ...
        echo '<form method="post" '
            ...
            . 'data-nonce-name="' . esc_attr($nonceName) . '"'
            . '>';
